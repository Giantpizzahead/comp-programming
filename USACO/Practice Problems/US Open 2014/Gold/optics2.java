...
public class optics2 {
    ...
    optics2(BufferedReader fin, PrintWriter fout) throws IOException {
        ...
        // Also add the laser to block the barn's simulation
        Mirror laser = new Mirror(laserX, laserY, N+1, true);
        xToMirrors[barnX].add(barn);
        yToMirrors[barnY].add(barn);
        xToMirrors[laserX].add(laser);
        yToMirrors[laserY].add(laser);
