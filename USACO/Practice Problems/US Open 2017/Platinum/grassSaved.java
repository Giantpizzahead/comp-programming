...
public class grassSaved {
    ...
    grassSaved(BufferedReader fin, PrintWriter fout) throws IOException {
        ...
        while (u1.time != INF || u2.time != INF) {
            if (u1.time < u2.time) {
                ...
                if (prevGrass1 == currGrass1) {
                    ...
                    u1 = updates[n1].delete(u1);
                } else if (!answers.queryInf(u1.time, u1.next.time - 1)) {
                    // Useless update (next one overrules this one)
                    u1 = updates[n1].delete(u1);
                } else if (currGrass1 == currGrass2) {
                ...
                if (prevGrass2 == currGrass2) {
                    // This update is useless
                    u2 = updates[n2].delete(u2);
                } else if (!answers.queryInf(u2.time, u2.next.time - 1)) {
    ...
    class SegmentTree {
        ...
        int queryMin(int i) {
            ...
            else return queryMin(1, 0, size - 1, i);
        }
