...
public class pushaboxnodyn {
    ...
    pushaboxnodyn(BufferedReader in, PrintWriter out) throws IOException {
...
//        }
    ...
    boolean[][][] visited = new boolean[MAXN][MAXM][4];
