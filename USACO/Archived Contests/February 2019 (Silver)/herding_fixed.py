...
Reattempting the problem to try and fix the two incorrect test cases.
Ok, literally the only problem was that there was a case where the cows
weren't sorted correctly from decreasing to increasing. That was it.
Wow... I would've gotten that... :(
'''
import bisect
...
def main():
    ...
    cows = sorted(cows)
    # print("Starting cows: {}".format(cows))
    least = smallest(cows)
    most = longest(cows)
