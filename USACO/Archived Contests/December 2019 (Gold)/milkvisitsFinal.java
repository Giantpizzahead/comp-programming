...
This only worked after tons of optimizations... some were good optimizations, other were sort of
'cheap'. But it worked after quite a few runs, and that's all that matters. Yay! :D
*/
...
public class milkvisitsFinal {
    ...
    TreeSet<Query>[] querySets;
    final int MAX_LCA = 16, INF = 987654321;

    milkvisitsFinal() throws IOException {
